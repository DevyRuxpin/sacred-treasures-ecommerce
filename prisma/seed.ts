...
// Image URL generators - Using reliable placeholder images
function getProductImage(slug: string): string {
  const imageMap: Record<string, string> = {
    'tasbih-amber-premium': 'https://picsum.photos/800/600?random=1',
    'crystal-tasbih-33': 'https://picsum.photos/800/600?random=2',
    'prayer-rug-traditional': 'https://picsum.photos/800/600?random=3',
    'quran-premium-arabic': 'https://picsum.photos/800/600?random=4',
    'rudraksha-mala-108': 'https://picsum.photos/800/600?random=5',
    'sandalwood-mala-108': 'https://picsum.photos/800/600?random=6',
    'tulsi-mala-108': 'https://picsum.photos/800/600?random=7',
    'aarti-lamp-brass': 'https://picsum.photos/800/600?random=8',
    'ganesha-idol-brass': 'https://picsum.photos/800/600?random=9',
    'kirpan-ceremonial-steel': 'https://picsum.photos/800/600?random=10',
    'kara-sikh-bracelet': 'https://picsum.photos/800/600?random=11',
    'guru-granth-sahib-punjabi': 'https://picsum.photos/800/600?random=12',
    'rosary-our-lady-lourdes': 'https://picsum.photos/800/600?random=13',
    'wooden-cross-olive-wood': 'https://picsum.photos/800/600?random=14',
    'crucifix-sterling-silver': 'https://picsum.photos/800/600?random=15',
    'bodhi-seed-mala-108': 'https://picsum.photos/800/600?random=16',
    'meditation-buddha-resin': 'https://picsum.photos/800/600?random=17',
    'laughing-buddha-jade': 'https://picsum.photos/800/600?random=18',
    'mezuzah-sterling-silver': 'https://picsum.photos/800/600?random=19',
    'tallit-traditional-white': 'https://picsum.photos/800/600?random=20',
    'kippah-set-assorted-colors': 'https://picsum.photos/800/600?random=21',
    'incense-sticks-sandalwood': 'https://picsum.photos/800/600?random=22',
    'prayer-candle-beeswax': 'https://picsum.photos/800/600?random=23'
  };
  return imageMap[slug] || 'https://picsum.photos/800/600?random=24';
}

function getCategoryImage(slug: string): string {
  const categoryImageMap: Record<string, string> = {
    'islamic': 'https://picsum.photos/400/300?random=100',
    'hindu': 'https://picsum.photos/400/300?random=101',
    'buddhist': 'https://picsum.photos/400/300?random=102',
    'sikh': 'https://picsum.photos/400/300?random=103',
    'christian': 'https://picsum.photos/400/300?random=104',
    'judaic': 'https://picsum.photos/400/300?random=105'
  };
  return categoryImageMap[slug] || 'https://picsum.photos/400/300?random=106';
}
